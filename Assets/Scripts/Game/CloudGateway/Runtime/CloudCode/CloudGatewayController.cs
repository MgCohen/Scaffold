...
using Scaffold.Infra.LifeCycle;
...
namespace Scaffold.Game.CloudGateway
{
    ...
    /// </summary>
    public class CloudGatewayController : ICloudGatewayService, IController
    {
        public CloudGatewayController(ICloudGatewayAuthKey cloudGatewayAuthKey, ICloudService cloudService, List<IGameModule> modules)
        {
