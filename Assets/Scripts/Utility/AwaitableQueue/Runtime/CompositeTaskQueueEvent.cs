...
namespace Scaffold.Utility.AwaitableQueue
{
    ...
    public class CompositeTaskQueueEvent<T>
    {
        ...
        /// </summary>
        public void Subscribe(Func<T, Task> subscriber, bool immediate)
        {
            if (immediate)
            {
        ...
        /// </summary>
        public void Unsubscribe(Func<T, Task> subscriber, bool immediate)
        {
            if (immediate)
            {
        ...
        /// </summary>
        public void Subscribe<TDerived>(Func<TDerived, Task> subscriber, bool immediate) where TDerived : T
        {
            if (immediate)
            {
        ...
        /// </summary>
        public void Unsubscribe<TDerived>(Func<TDerived, Task> subscriber, bool immediate) where TDerived : T
        {
            if (immediate)
            {
