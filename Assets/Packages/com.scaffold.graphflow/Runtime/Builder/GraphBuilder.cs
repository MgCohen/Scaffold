...
namespace Scaffold.GraphFlow
{
    public abstract class GraphBuilder<TRunner> where TRunner : GraphRunner
    {
        ...
        // closure that reads the runner's typed variable handle. Note: BakedGraph (and the
