...
- `scaffold.SCA3006.content_roots` — semicolon-separated path markers (default `Assets/Scripts`). This repo also lists `LiveOps/Deploy/Core/LiveOps.Core`, `LiveOps/Deploy/Core/LiveOps.DTO`, `LiveOps/Deploy/LiveOps`, `LiveOps/Scaffold`, and `LiveOps/Game` for Cloud Code sources.
