...
namespace Scaffold.MVVM
{
    ...
    public partial class InventoryViewModel
    {
        ...
        private static async Task<ImmutableArray<Diagnostic>> GetDiagnosticsAsync(string source, string filePath)
        {
            ...
            var analyzer = new MvvmAttributeReferenceAnalyzer();
            ...
            return diagnostics.Where(diagnostic => diagnostic.Id == MvvmAttributeReferenceAnalyzer.DiagnosticId).ToImmutableArray();
        }
