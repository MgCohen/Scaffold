...
namespace Scaffold.Analyzers
{
    ...
    public class MethodCommentAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableString MessageFormat = "Error SCA1001: Method '{0}' has an invalid comment. Remove the comment entirely or change it to include 'todo' or 'sample'.";
