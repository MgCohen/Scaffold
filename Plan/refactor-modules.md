...
The final artifact of this plan is the ExecPlan file itself, written to `Plan/refactor-modules.md` in the repository, plus all implementation changes.
...
- [x] Create ExecPlan file at `Plan/refactor-modules.md`
