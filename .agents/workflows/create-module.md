...
9.  **Boundary Hygiene (Best Practice)**:
    ...
    - Default external dependencies to `<Module>`; reserve foreign runtime-only dependencies for composition roots (your application startup / `ApplicationBootstrap` subclass) and module-local wiring.
