...
namespace GameModule.GameModule
{
    ...
    {
        /// <summary>Gets a value indicating whether this module executes on client logic.</summary>
        public bool Client { get; }
        
        /// <summary>Gets a value indicating whether this module executes on server logic.</summary>
